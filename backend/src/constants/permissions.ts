...
export const SEED_PERMISSIONS: { key: string; name: string; module: string; description: string }[] = [
  ...
  { key: PERMISSIONS.PERMISSION_VIEW, name: "View Permissions", module: "Permissions", description: "Can view and search permissions" },
  { key: PERMISSIONS.PERMISSION_CREATE, name: "Create Permissions", module: "Permissions", description: "Can create new permissions" },
  { key: PERMISSIONS.PERMISSION_UPDATE, name: "Update Permissions", module: "Permissions", description: "Can update permission details" },
  { key: PERMISSIONS.PERMISSION_DELETE, name: "Delete Permissions", module: "Permissions", description: "Can delete permissions" },
  { key: PERMISSIONS.ASSIGN_VIEW, name: "View Assign Permissions", module: "Assign Permissions", description: "Can view role permission assignments" },
  { key: PERMISSIONS.ASSIGN_MANAGE, name: "Manage Assign Permissions", module: "Assign Permissions", description: "Can assign or revoke role permissions" },
